...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_QWERTY] = LAYOUT_voyager(
    DRAG_SCROLL,    TOGGLE_SCROLL,  NAVIGATOR_DEC_CPI,NAVIGATOR_INC_CPI,MS_BTN2,      MS_BTN1,                                        LCTL(KC_C),     LCTL(KC_V),     KC_LEFT,        KC_RIGHT,       KC_PLUS,        KC_MINUS,
  ...
  [L_NUM] = LAYOUT_voyager(
    ...
    KC_NO,          KC_MINS,        KC_3,           KC_2,           KC_1,           KC_PLUS,                                        KC_NO,          KC_RSFT,        KC_RCTL,        KC_RALT,        KC_RGUI,        KC_NO,
