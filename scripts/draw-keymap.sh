...
perl -0pi -e "s/{t: MS BTN1, type: trans}/Click/g; s/MS BTN1/Click/g; s/MS BTN2/Right Click/g; s/MS BTN4/Back Btn/g; s/MS BTN5/Forward Btn/g; s/{t: Ctl\\+Gui\\+Sft\\+4, type: trans}/Area Copy/g; s/Ctl\\+Gui\\+Sft\\+4/Area Copy/g; s/{t: Ctl\\+Gui\\+Sft\\+3, type: trans}/Screen Copy/g; s/Ctl\\+Gui\\+Sft\\+3/Screen Copy/g; s/{t: Gui\\+Sft\\+Z, type: trans}/Redo/g; s/Gui\\+Sft\\+Z/Redo/g; s/{t: Gui\\+L, type: trans}/Cmd+L/g; s/Gui\\+L/Cmd+L/g" "$tmp_yaml"
perl -0pi -e "s/CAG MOD/CAG/g; s/GESTURE/Gesture/g; s/NAVIGATOR DEC CPI/CPI-/g; s/NAVIGATOR INC CPI/CPI+/g; s/TOGGLE SCROLL/Scroll Toggle/g; s/DRAG SCROLL/Drag Scroll/g; s/{t: ▽, h: Mouse, type: trans}/Mouse Off/g; s/OSM\\(MOD_LCTL\\)/OSM CTL/g; s/OSM\\(MOD_LALT\\)/OSM ALT/g; s/OSM\\(MOD_LGUI\\)/OSM GUI/g; s/OSM\\(MOD_LSFT\\)/OSM SFT/g" "$tmp_yaml"
