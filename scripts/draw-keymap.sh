...
perl -0pi -e "s/{t: UND NAV, h: Nav}/{t: '_', h: Nav}/g; s/UND NAV/{t: '_', h: Nav}/g; s/{t: F19, h: Nav}/{t: '_', h: Nav}/g; s/{t: SPACE, h: Media}/SPACE/g; s/{t: '~', type: trans}/'~'/g; s/ARROW/'->'/g" "$tmp_yaml"
